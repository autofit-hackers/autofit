...
def draw_landmarks(
    ...
    for index, landmark in enumerate(landmarks.landmark):
        ...
        if index == 0:  # 鼻
            cv.circle(image, (landmark_x, landmark_y), 5, color, 2)
        if index == 1:  # 右目：目頭
            cv.circle(image, (landmark_x, landmark_y), 5, color, 2)
        if index == 2:  # 右目：瞳
            cv.circle(image, (landmark_x, landmark_y), 5, color, 2)
